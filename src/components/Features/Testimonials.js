          ...
          <div className="carousel-inner" role="listbox">
            <div className="carousel-item active">
              <div className="testimonial4_slide">
                <img src="https://i.ibb.co/8x9xK4H/team.jpg" className="img-circle img-responsive" alt="name" />
                <p>eTeachersRecruit is amazing. All the teachers deployed to my school are good at what they do that I cannot even ask for more. I recommend them any day for qualified teachers </p>
                <h4>Adab Michael</h4>
              </div>
            </div>
